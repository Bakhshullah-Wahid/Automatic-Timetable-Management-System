...
import 'package:attms/wholeData/default_data.dart';
            ...
            ElevatedButton(
                onPressed: () {
                  if (formkey.currentState!.validate() &&
                    ...
                    if (userId == null) {
                      if (departmentCheck(department.text, formattedManager)) {
                        managerUpdate.addManager(userName.text, 'Co-ordinator',
                            email.text, password.text, departmentId!);
